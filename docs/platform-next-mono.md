...
Generated: 2026-04-02 18:11:36 UTC
...
- [#1096 Feature/lighthouse report 17 03 26](https://github.com/RoyalVoluntaryService/platform-next-mono/pull/1096) — 16d 3h
- [#1175 🐛 fix: disable auto-populated fields in Team Day express interest about step](https://github.com/RoyalVoluntaryService/platform-next-mono/pull/1175) — 1d 3h
...
- [#1278 GV-3883: Display "Remote" for team day list cards with remote location](https://github.com/RoyalVoluntaryService/platform-next-mono/pull/1278) — 8h 18m
- [#1279 fix(GV-2980): prevent opportunity card floating over map on marker/card selection](https://github.com/RoyalVoluntaryService/platform-next-mono/pull/1279) — 7h 58m
- [#1282 GV-3842: Notify charity admin of new EOI via dashboard toast](https://github.com/RoyalVoluntaryService/platform-next-mono/pull/1282) — 6h 3m

## Rules

- Age colour is based only on PR age: 🟩 < 1 day, 🟨 1–2 days, 🟥 > 2 days.
- Approvals counts only current human approvals; bots/Copilot are ignored.
- Changes Requested shows current human reviewers whose latest review state is changes requested.
- Build uses check name: `build-web`.
- Unit Test uses check name: `unit-test`.
- Can Merge = at least 2 human approvals, no active changes requested, build ✓, unit test ✓.
